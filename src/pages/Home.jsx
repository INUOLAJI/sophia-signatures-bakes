...
import { fadeUp, fadeLeft, fadeRight, scaleIn, staggerContainer, floatAnimation, cardHover } from '../animations';
...
const SIGNATURE_FLAVORS = [
  { name: 'Classic Vanilla', desc: 'Soft, Moist & Buttery Vanilla', tag: 'Classic Favorite', image: '/vanillaflavour.jpeg' },
  { name: 'Dark Chocolate', desc: 'Deep, Rich & Moist Chocolate', tag: 'Best Seller', image: '/chocolateflavour.jpeg' },
  { name: 'Red Velvet', desc: 'Silky, Moist & Velvety Red Velvet', tag: 'Crowd Pleaser', image: '/redvioletflavour.jpeg' },
  { name: 'Strawberry Bliss', desc: 'Soft, Moist & Delicately Sweet Strawberry', tag: 'Fruity & Fresh', image: '/strawberryflavour.jpeg' },
];
  ...
  return (
    <Container className="py-5">
      ...
      <Row className="align-items-center gy-4 mb-5 pb-3">
        <Col lg={6}>
          <motion.div variants={fadeLeft} initial="hidden" animate="visible">
            <div className="d-inline-flex align-items-center gap-2 px-3 py-1 rounded-pill badge-gold-accent mb-3">
              <img src="/sophia-logo.jpeg" alt="Sophia's Signature Bakes" className="rounded-circle" style={{ width: '24px', height: '24px', objectFit: 'cover' }} />
        ...
        <Col lg={6}>
          <motion.div variants={fadeRight} initial="hidden" animate="visible" className="position-relative">
            <motion.img
      ...
      >
        <h2 className="fw-bold text-golden-dark" style={{ fontFamily: "'Playfair Display', serif" }}>What We Bake Best</h2>
                  ...
                  <Card className="h-100 border-0 shadow-sm rounded-4 overflow-hidden bg-white">
                    <div className="position-relative overflow-hidden">
                      <motion.div whileHover={{ scale: 1.07 }} transition={{ duration: 0.4 }}>
                        <Card.Img variant="top" src={item.image} alt={item.title} style={{ height: '220px', objectFit: 'cover' }} />
                      </motion.div>
                    ...
                    <Card.Body className="p-4 d-flex flex-column justify-content-between">
                      ...
                      <div className="mt-3 pt-2 border-top border-golden">
                        <Button as={Link} to={item.link} variant="link" className="p-0 text-golden text-decoration-none fw-bold">
                          View Menu & Pricing →
                        </Button>
                      </div>
                    </Card.Body>
      ...
      {/* Custom Cake Banner */}
      <motion.div
        className="p-4 p-md-5 rounded-4 mb-5 shadow-sm border border-golden bg-white position-relative overflow-hidden"
        variants={fadeUp}
        initial="hidden"
        whileInView="visible"
        ...
        <Row className="align-items-center gy-4">
          <Col lg={7}>
            <motion.div variants={fadeLeft} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              <Badge className="badge-gold-accent px-3 py-2 rounded-pill mb-2">🎨 Interactive Cake Studio</Badge>
              ...
              <p className="text-golden-text-muted mb-4 fs-6">
                Use our brand new <strong>Custom Order Form</strong> to choose your size, customize flavors & fillings, luxury toppers, and receive an instant quote ready for WhatsApp!
              </p>
              <div className="d-flex flex-wrap gap-3">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          ...
          <Col lg={5}>
            <motion.div variants={fadeRight} initial="hidden" whileInView="visible" viewport={{ once: true }} className="position-relative">
              <motion.img
      ...
      {/* Signature Flavors */}
      <motion.div
        className="bg-golden-subtle p-4 p-md-5 rounded-4 mb-5 border border-golden"
        variants={fadeUp}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.15 }}
      >
        <div className="text-center mb-4">
          ...
          <h2 className="fw-bold text-golden-dark" style={{ fontFamily: "'Playfair Display', serif" }}>Handcrafted Signature Flavors</h2>
                    ...
                    <Card className="h-100 border-0 shadow-sm rounded-4 overflow-hidden bg-white text-center">
                      <div className="overflow-hidden">
                        <motion.div whileHover={{ scale: 1.08 }} transition={{ duration: 0.4 }}>
                          <Card.Img variant="top" src={flavor.image} alt={flavor.name} style={{ height: '160px', objectFit: 'cover' }} />
                        </motion.div>
                      </div>
      ...
      {/* CTA Banner */}
      <motion.div
        className="discount-ribbon p-4 p-md-5 text-center shadow-sm"
        variants={scaleIn}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.3 }}
